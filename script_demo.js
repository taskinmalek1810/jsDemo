...
const validationForm = () => {
    ...
    let namereState = checkNameRE(nameEle);
    let nameState = checkName(nameEle, 3, 15);
    ...
    if (namereState == true && nameState == true && emailState == true && ageState == true && countryState == true && stateState == true && cityState == true && genderState != false && hobbyState != false) {
        return flag = true;
    }
    return flag;
}
